...
const Friends = () => {
    return (
        ...
        //             <div className="card" style={{ width: "430px", marginTop: "10px", marginLeft: "10px" }}>
        //                 <div className="card-body">
        //                     <div className="row">
        //                         <div className="col-md-2">
        //                             <Link to="#" style={{ textDecoration: "none" }}>
        //                                 <img style={{ width: "40px", height: "40px" }} className="rounded-circle my-2" alt="avatar1" src="https://mdbcdn.b-cdn.net/img/new/avatars/9.webp" />
        //                             </Link>
        //                         </div>
        //                         <div className="col my-3" style={{ fontWeight: "bold", color: "blue", textDecoration: "none" }}>
        //                             <Link to="#" style={{ textDecoration: "none" }}>
        //                                 Somnath Yadav
        //                             </Link>
        //                         </div>
        //                         <div className="col my-2" style={{ fontWeight: "bold", color: "blue" }}>
        //                             <Link to="#" style={{ fontWeight: "bold", color: "blue", textDecoration: "none" }}>
        //                                 . . .
        //                             </Link>
        //                         </div>
        //                     </div>
        ...
        //         </div>
        //         <div className="col">
        //             <div className="card" style={{ width: "100%", height: "700px", marginTop: "10px", marginLeft: "10px" }}>
        //                 <div className="card-body">
        //                     <div className="card top-0" style={{ width: "100%", height: "70px" }}>
        //                         <div className="card-body">
      ...
      <div className="min-w-full border rounded lg:grid lg:grid-cols-3" style={{height: "700px"}}>
